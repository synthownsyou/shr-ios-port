...
struct radTvosDirHandle
{
    std::filesystem::directory_iterator it;
    std::filesystem::directory_iterator end;
    char pattern[ radFileFilenameMax + 1 ];
};

typedef radTvosFileHandle* radFileHandle;
typedef radTvosDirHandle radFileDirHandle;
#endif
