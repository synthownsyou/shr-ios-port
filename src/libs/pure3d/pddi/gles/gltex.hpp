...
public:
    ...
    // Video texture flag - video textures need positive pitch for sws_scale
    virtual void SetVideoTexture(bool isVideo) override { isVideoTexture = isVideo; }
    bool IsVideoTexture() const { return isVideoTexture; }
...
protected:
    ...
    bool isVideoTexture;  // True for video textures that need positive pitch
};
#endif
