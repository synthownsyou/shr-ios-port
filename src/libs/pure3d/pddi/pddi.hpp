...
#if defined( RAD_WIN32 ) || defined( RAD_LINUX ) || defined( RAD_TVOS )
...
public:
    ...
    // Video texture flag - needed for platforms where video textures require different handling
    virtual void SetVideoTexture(bool isVideo) {}
