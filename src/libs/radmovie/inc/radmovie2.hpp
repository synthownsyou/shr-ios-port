...
struct IRadMoviePlayer2 : public IRefCount
{
    ...
    #if ( defined RAD_XBOX || defined RAD_WIN32 || defined RAD_TVOS || defined RAD_MOVIEPLAYER_USE_BINK )
...
{
    #if defined RAD_WIN32 || defined RAD_TVOS || defined RAD_MOVIEPLAYER_USE_BINK
