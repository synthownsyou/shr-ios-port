...
#if defined(RAD_TVOS)
class TVOSReverbController : public ReverbController
{
public:
    TVOSReverbController() {}
    virtual ~TVOSReverbController() {}
...
#elif defined(RAD_TVOS)
    m_reverbController = new(GMA_PERSISTENT) TVOSReverbController();
#else
