...
#define INIT_MEM()  Memory::InitializeMemoryUtilities();IosPlatform::InitializeMemory();
#define SHUTDOWN_MEM()  IosPlatform::ShutdownMemory();
void MemoryHackCallback() { INIT_MEM() };
#elif defined(RAD_TVOS)
#error "RAD_TVOS without RAD_IOS is not supported by this iOS-retargeted tree -- see PORTING-NOTES.md"
#endif
