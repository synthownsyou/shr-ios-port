...
#ifdef RAD_GAMECUBE
    uni_string = GetTextBibleString( "MSG_CONTROLLER_DISCONNECTED_(GC)" );
#endif

#ifdef RAD_XBOX
    uni_string = GetTextBibleString( "MSG_CONTROLLER_DISCONNECTED_(XBOX)" );
#endif

#ifdef RAD_PS2
    uni_string = GetTextBibleString( "MSG_CONTROLLER_DISCONNECTED_(PS2)" );
