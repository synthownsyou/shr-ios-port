...
{
#ifdef RAD_TVOS
    rDebugPrintf( "[GUIInput] Start pressed: controllerId=%d\n", controllerId );
#endif
...
{
#ifdef RAD_TVOS
    rDebugPrintf( "[GUIInput] Select pressed: controllerId=%d\n", controllerId );
#endif
...
{
#ifdef RAD_TVOS
    rDebugPrintf( "[GUIInput] OnButtonDown: controllerId=%d buttonId=%d\n", controllerId, buttonId );
#endif
...
{
#ifdef RAD_TVOS
    rDebugPrintf( "[GUIInput] LoadControllerMappings: controllerId=%d NUM_MAPPINGS=%d\n", controllerId, NUM_GUI_CONTROL_MAPPINGS );
#endif
    // now set controller mappings
    for( int i = 0; i < NUM_GUI_CONTROL_MAPPINGS; i++ )
    {
#ifdef RAD_TVOS
        if( GUI_CONTROL_MAP[ i ].inputName[0] != '\0' )
        {
            rDebugPrintf( "[GUIInput]   Mapping '%s' -> inputID=%d\n", GUI_CONTROL_MAP[ i ].inputName, GUI_CONTROL_MAP[ i ].inputID );
        }
#endif
