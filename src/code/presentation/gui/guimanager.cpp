    ...
    switch( message )
    {
        ...
        case GUI_MSG_GOTO_SCREEN:
        {
...
#if defined(RAD_TVOS)
            printf( "[GuiManager] GUI_MSG_GOTO_SCREEN: current=%d next=%d\n", 
                    (int)m_currentScreen, (int)nextScreen );
            fflush( stdout );
#endif
            ...
            if( this->FindWindowByID( nextScreen ) == NULL )
            {
                ...
                //
#if defined(RAD_TVOS)
                printf( "[GuiManager] GUI_MSG_GOTO_SCREEN: screen %d NOT FOUND!\n", (int)nextScreen );
                fflush( stdout );
#endif
                break;
            }
...
#if defined(RAD_TVOS)
            printf( "[GuiManager] GUI_MSG_GOTO_SCREEN: changing from %d to %d\n", 
                    (int)m_currentScreen, (int)m_nextScreen );
            fflush( stdout );
#endif
