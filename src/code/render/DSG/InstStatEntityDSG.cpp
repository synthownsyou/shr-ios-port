...
#ifdef RAD_TVOS
// External flag to force Zone 3 geometry to render red (defined in glmat.cpp)
extern bool g_debugForceZone3Red;

// Zone 3 (Lisa's School) bounding box check for InstStatEntityDSG
static bool IsInstInZone3(float x, float z)
{
    // Zone 3 roughly covers: X from -250 to 100, Z from -650 to -350
